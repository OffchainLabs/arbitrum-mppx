...
export const ANVIL_TEST_ACCOUNTS = {
  server: {
    ...
    privateKey: '0xc1acab0b3f734a64c96a87078b379778cce6a0d441291ae66082dae55b1bd675' as const,
  },
  client: {
    address: '0xB37a9B65c2e71C4A312aC837d0781de2F08abAbC' as const,
    privateKey: '0x3312c2e3b5ae954fcb6db2cfa5930a84cc4ff7e8b0a1ac07ed88487de1b033f0' as const,
  },
  splits1: {
